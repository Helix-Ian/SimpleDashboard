        ...
        <div className='ControllerContainer'>
          <div className='ReportContainer'>
            {this.state.informationFromApi.map((info, i) => (
              <div
                key={i}
                className={`Page${info.pageNumber} Wrapper`}
                ref={this.refArray[i]}
              >
                <ReportPage
                  commentCallback={this.commentCallback.bind(this)}
                  key={info.pageNumber}
                  pageJson={info}
                />
              </div>
          ...
          <div className='TOCContainer'>
            <TableOfContents
              commentRefs={this.state.commentRefs}
              lastActiveCommentId={this.state.lastActiveCommentId}
              refArray={this.refArray}
              tocJson={this.state.ToCSeed}
            />
          </div>
        </div>
      </div>
